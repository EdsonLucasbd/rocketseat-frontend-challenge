...
export const PixForm = ({ value }: PixProps) => {
  return (
    ...
    border w-full md:w-[23.4375rem]">
      <>
        <p className='font-medium text-color-text md:text-start'>Informações sobre o pagamento via Pix:</p>
        <ul className='list-disc'>
          <li className='text-color-text font-light list-inside'>Valor à vista: <b>R$ {value}</b>.</li>
          <li className='text-color-text font-light list-inside'>Não podemos parcelar o Pix.</li>
          <li className='text-color-text font-light list-inside'>Pagamento consta imediatamente.</li>
        </ul>
      </>
